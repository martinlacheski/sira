...
from apps.geo.forms import ProvinciasForm
from apps.geo.models import Provincias
...
class ProvinciasListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('geo:provincias_create')
        context['list_url'] = reverse_lazy('geo:provincias_list')
