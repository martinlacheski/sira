...
from apps.geo.views.localidades import views
from apps.geo.views.paises.views import *
from apps.geo.views.provincias.views import *
from apps.geo.views.localidades.views import *
...
urlpatterns = [
    ...
    #Localidades select anidado con AJAX
